...
function callJake(phoneNumber) {
  var dialer = callFriend("Jake");
  return dialer(phoneNumber);
}
var result = callJake("435-555-9248");


// var callJake = callFriend("Jake"0;
// return callJake("435-555-9248");
console.log(result);
